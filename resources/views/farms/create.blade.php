...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('feed_inventory.index', $farm->id) }}">Feed Inventory</a>
                    </li>
    ...
    <form action="{{ route('feed_inventory.store', $farm->id) }}" method="POST" id="feedForm">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('feed_inventory.index', $farm->id) }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-footer text-end">
                        ...
                        <a href="{{ route('feed_inventory.index', $farm->id) }}" class="btn btn-secondary px-4">
                            <i class="material-icons-outlined">cancel</i> Cancel
                        </a>
                    </div>
                </div>
