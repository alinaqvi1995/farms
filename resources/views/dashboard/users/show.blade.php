        ...
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                    ...
                    @if ($currentUser->isSuperAdmin() || ($currentUser->isFarmAdmin() && $currentUser->farm_id == $user->farm->id))
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        @if ($user->farm)
                            <div class="col-md-6"><strong>Farm:</strong>
                                <a href="{{ route('farms.show', $user->farm->id) }}">{{ $user->farm->name }}</a>
                            </div>
                        @endif
                    </div>
                </div>
