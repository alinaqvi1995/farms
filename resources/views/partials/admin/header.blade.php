    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="#sidebarHospital" class="nav-link menu-link  collapsed" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarHospital">
                ...
                <li class="nav-item">
                    <a href="apps-calendar.html" class="nav-link menu-link"> <i class="bx bx-calendar"></i> <span
                            ...
                            <form class="p-3">
                                <div class="form-group m-0">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-grd btn-grd-primary" type="submit"><i
                        ...
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle"
                            ...
                            <span
                                class="position-absolute topbar-badge fs-3xs translate-middle badge rounded-pill bg-danger"><span
                                    class="notification-badge">{{ $recentActivities->count() }}</span><span
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h6 class="mb-0 fs-lg fw-semibold"> Notifications <span
                                                    ...
                                                    {{ $recentActivities->count() }}</span></h6>
                                        </div>
                            ...
                            <div class="pb-2 ps-0" id="notificationItemsTabContent">
                                <div data-simplebar style="max-height: 300px;" class="pe-0">
                                    <h6 class="text-overflow text-muted fs-sm my-2 notification-title px-3">Recent</h6>
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="fs-md text-muted">
                                                        <p class="mb-1 text-muted">
                                                            <b>{{ $activity->readable_causer }}</b>
                                                            {{ $activity->description }}
                                                            <a
                                                                href="{{ route('view.activity_logs') }}">#{{ $activity->subject_id }}</a>
                                                        </p>
                                                    </div>
                                ...
                                <div class="notification-actions" id="notification-actions">
                                    <div class="d-flex text-muted justify-content-center align-items-center">
                                        <a href="{{ route('view.activity_logs') }}"
                                            class="btn btn-link link-primary p-0 ms-2">View All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
